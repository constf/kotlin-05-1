...
class Notes {
    ...
    private var notesList: ArrayList<Note> = ArrayList<Note>()
    private var notesDeleted: ArrayList<Note> = ArrayList<Note>()

    private var commentsList: ArrayList<CommentNote> = ArrayList<CommentNote>()
    private var commentsDeleted: ArrayList<CommentNote> = ArrayList<CommentNote>()
    ...
    fun getComments(noteId: UInt, ownerId: UInt = 0U, sort: UInt = 0U, offset: UInt = 0U, count: UInt = 0U): List<CommentNote> {
        val nid = noteId
